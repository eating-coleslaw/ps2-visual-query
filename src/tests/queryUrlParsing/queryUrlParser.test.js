...
test("Inner join example", () => {
  const input = "https://census.daybreakgames.com/get/ps2/map?world_id=1&zone_ids=2&c:join=map_region^inject_at:map_region^on:Regions.Row.RowData.RegionId^to:map_region_id";
...
test("Cooltrain's chonky character", () => {
  ...
  */
  ...
  expected.filterFields = [ "head_id", "title_id", "profile_id", "times.creation", "times.creation_date", "times.last_save", "times.last_save_date", "times.last_login", "times.login_count", "daily_ribbon", "certs.gifted_points", "certs.spent_points", "certs.available_points", "certs.percent_to_next", "battle_rank.percent_to_next" ];
  ...
  */
  ...
  killsRootJoin.filterFields = [ "character_id", "day", "week", "month", "last_save", "last_save_date", "one_life_max" ];
  ...
  deathsRootJoin.filterFields = [ "character_id", "day", "week", "month", "last_save", "last_save_date", "one_life_max" ];
  ...
  scoreRootJoin.filterFields = [ "character_id", "day", "week", "month", "last_save", "last_save_date", "one_life_max" ];
